...
<body>
    <div id=":uf" class="ii gt" jslog="20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.">
        <div id=":ue" class="a3s aiL ">
            <div style="line-height:14pt;padding:20px 0px;font-size:14px;max-width:780px;margin:0 auto">
                <div class="adM">
                </div>
                ...
                <div style="padding:0 10px">
                                ...
                                <td style="padding-right:15px">
                                    <table style="width:100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="word-break:break-word;word-wrap:break-word"><a href="mailto:sendmaildatn@gmail.com" target="_blank">
                                                        ${email}
                                                    </a></td>
                                            </tr>
                                            <tr>
                    ...
                    <table style="width:100%;border-collapse:collapse;margin-top:20px">
                        ...
                        <tbody>
                            <tr>
                                <td style="padding-right:15px">Thanh toán qua ${paymentMethod}
                                </td>
                                <td>
                                    Đường bộ<br>
                                </td>
                ...
                <div style="margin-top:20px;padding:0 10px">
                    ...
                    <table style="width:100%;margin:10px 0">
                        <tbody>
                            <tr>
                                <td style="width:50%;padding-right:15px">Mã đơn hàng: ${orderCode}
                                </td>
                                <td style="width:50%"><strong>Ngày đặt hàng:</strong>
                                    ${createDate}
                                </td>
                            </tr>
                        </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width:70%;padding:5px 0px 25px">
                                                <div style="margin-left:100px">
                                                    ${p.price}₫ <span style="margin-left:20px">x ${p.quantity}
                                                    </span>
                                                </div>
                                            </td>
                ...
                <div style="padding:0 10px">
                    <p style="margin:30px 0"><span style="font-weight:bold">Ghi chú: ${note}
                        </span> </p>
                </div>
                <div style="clear:both"></div>
                <div style="padding:0 10px">
                    <p style="height:50px">
                        ...
                        <span style="margin-top:25px;float:left">
                            <span style="padding:14px 35px;background:#357ebd">
                                <a href="" style="font-size:16px;text-decoration:none;color:#fff" target="_blank" href="http://localhost:4200/sign-in">Đăng nhập vào tài khoản</a>
                            </span>
                        </span>
                    </p>
                    <div style="clear:both"></div>
                    <p style="margin:30px 0">Nếu Anh/chị có bất kỳ câu hỏi nào, xin liên hệ với chúng tôi tại <a href="mailto:sendmaildatn@gmail.com" style="color:#357ebd" target="_blank">sendmaildatn@<span class="il">gmail</span>.com</a></p>
                    <p style="text-align:right"><i>Trân trọng,</i></p>
                    <p style="text-align:right"><strong>Ban quản trị cửa hàng <span class="il">SHOES STORE</span></strong></p>
                </div>
            </div>
