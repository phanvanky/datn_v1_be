...
<div id=":uf" class="ii gt" jslog="20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.">
    <div id=":ue" class="a3s aiL ">
        <div style="line-height:14pt;padding:20px 0px;font-size:14px;max-width:780px;margin:0 auto"><div class="adM">
                    ...
                    <tr>
                        <td style="padding-right:15px">
                            <table style="width:100%">
                                <tbody>
                                <tr>
                                    <td><strong>Họ và tên:</strong> ${name}</td>
                                </tr>

                                <tr>
                                    <td style="word-break:break-word;word-wrap:break-word"><a href="mailto:sendmaildatn@gmail.com" target="_blank"> ${email}</a></td>
                                </tr>
                        ...
                        <td>
                            <table style="width:100%">
                                ...
                                <tr>
                                    <td><strong>Họ và tên:</strong> ${nameOfRecipient}</td>
                                </tr>
                                ...
                                <tr>
                                    <td><strong>Số điện thoại:</strong> ${phoneOfRecipient}</td>
                                </tr>
            ...
            <div style="margin-top:20px;padding:0 10px">
                ...
                <table style="width:100%;margin:10px 0">
                    <tbody><tr>
                        ...
                        <td style="width:50%"><strong>Ngày đặt hàng:</strong> ${createDate}</td>
                    </tr>
                    </tbody></table>
